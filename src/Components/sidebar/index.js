    ...
    return (
        <div className={"h-100"}>
            <ul className={"list-unstyled mt-3 text-white"}>
                ...
                <li className="p-0"><NavLink activeClassName={"activeNavLink"} className={"pl-2 py-2 w-100 d-flex mb-1"} to="/home">Homescreen</NavLink></li>
                ...
                <li className="p-0"><NavLink activeClassName={"activeNavLink"} className={"pl-2 py-2 w-100 d-flex mb-1"} to="/blogs">Blog</NavLink></li>
            </ul>
        </div>
    )
}
