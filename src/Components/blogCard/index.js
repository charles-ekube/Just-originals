...
export const BlogCard = ({Blogs, setBlogs}) => {
    ...
    return (
        ...
        <main>
            <tr className={"align-items-center bg-white"} style={{display:'flex',justifyContent:'space-between'}}>
                <td className={"align-middle"}><input type="checkbox" /></td>

                <td className={"align-middle"}><img src={blog.avatar} alt="" className={"rounded border avatar"}  style={{width:'100px', height:'100px'}}/></td>
                ...
                <td className={"align-middle"}>
                    <div className="dropleft">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <p className="dropdown-item" data-toggle="modal" data-target={`#deleteModal${blog.id}`}>Remove</p>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <div className="modal fade" id={`deleteModal${blog.id}`} tabindex="-1" role="dialog" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-body p-5 text-center">
                            <p>Are you sure you want to remove {blog.title} from the list?</p>
                        </div>
                        <div className="modal-footer justify-content-center">
                            ...
                            <button type="button" className="btn btn-md px-5 btn-primary primaryBG"
                                 onClick= {
                                    async () => {
                                       await fetch(`https://just-original.herokuapp.com/api/v1/blogs/${blog.id}`, { method: 'DELETE' });
