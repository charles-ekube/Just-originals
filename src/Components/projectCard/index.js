              ...
              >
                <div className="modal-content">
                  <div className="modal-body p-5 text-center">
                    <p>
                      Are you sure you want to remove {project.title} from the
                      list?
                    </p>
                  </div>
                    ...
                    <button
                      ...
                      onClick={async () => {
                        ...
                        const deleteFunction = await fetch(
                          `https://just-original.herokuapp.com/api/v1/projects/${project.id}`,
                          {
                            method: "DELETE",
                            headers: {
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body p-5 text-center">
                    <div className="row">
                      ...
                      <div className="col-5">
                        <input
                          className={"mb-3 border greyBG p-2 rounded w-100"}
                          placeholder={"Name"}
                        />
                        <input
                          className={"mb-3 border greyBG p-2 rounded w-100"}
