...
const ExploreDisplay = (props) => {
  ...
  React.useEffect(() => {
    const fetchTalentTestimonies = async () => {
      const response = await fetch(
        `https://just-original.herokuapp.com/api/v1/talents/${query}/testimonies`
      );
      const data = await response.json();
      const item = data.data;
      if (item) {
    ...
    <>
      <section>
        ...
        <main data-aos="fade-down" data-aos-duration="2000">
          <section
            style={{ background: "rgba(251, 248, 251, 1)", paddingTop: "50px" }}
          >
            <section
              className="explore-display-intro"
              data-aos="fade-up"
          ...
          <section
            className="previous-projects-carousel-container"
            data-aos="fade-up"
            data-aos-duration="2000"
          >
          ...
          <section
            className="testimonies-carousel-container"
            data-aos="fade-up"
            data-aos-duration="2000"
          >
          ...
          <section
            style={{ background: "#fff", padding: "30px 10px" }}
            data-aos="fade-up"
            data-aos-duration="2000"
          >
            <div className="previous-projects-carousel-text">
